...
public:
    ...
    {
	bool Available = 0;
	//available dhondna abhi
	//filhal set to 0
	for (int i = 1; i < 20; i++)
	{
		if (total_room[i] == "Free")
		{
			total_room[i] = "Not_Free";
			Available = 1;
			//mil gya :-)
